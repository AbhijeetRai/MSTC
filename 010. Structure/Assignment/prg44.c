...
int main(void) {
    ...
    strncpy(my_chair.dealer, "NeelKamal", strlen("Neelkamal"));
    strncpy(my_chair.color, "White", strlen("White"));
    strncpy(my_chair.type, "Plastic Chair", strlen("Plastic Chair"));
    my_chair.price = 600; 
    my_chair.weight = 700;
